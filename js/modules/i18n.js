...
const translations = {
  pt: {
    ...
    'profile.text': 'Sou um desenvolvedor fullstack com experiência em tecnologias modernas para web. Atuo focado na construção de aplicações escaláveis e bem arquitetadas. Minha trajetória combina formação técnica, experiência prática em projetos e resolução de problemas reais em sistemas de produção.',
